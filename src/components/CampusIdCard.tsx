...
function StatChip({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex-1 rounded-2xl px-3 py-2.5 glass">
      <p className="text-[10px] font-medium uppercase tracking-[0.14em] text-foreground/75">{label}</p>
  ...
  return (
    <div className="relative overflow-hidden rounded-[28px] card-hero p-5 pb-4">
      ...
      <div className="relative flex items-start justify-between">
        ...
        <div className="grid h-9 w-12 place-items-center rounded-lg border border-foreground/30 bg-foreground/25">
